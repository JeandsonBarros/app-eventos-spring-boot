...
public class Segurança extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST, "/").permitAll()
				.antMatchers(HttpMethod.POST, "/feed/evento/{codigo}").permitAll()
				.antMatchers(HttpMethod.GET, "/seus-eventos").hasAnyAuthority("USER", "ADMIN").antMatchers(HttpMethod.POST, "/cadastrarEvento").hasAnyAuthority("USER", "ADMIN")
				.antMatchers(HttpMethod.GET, "/seus-eventos").hasAnyAuthority("USER", "ADMIN")
